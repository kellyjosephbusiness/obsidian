...
import { SpecialtyPrograms } from "@/components/sites/corgi-insure-a0f7893c/products/SpecialtyPrograms";
 ...
 * (#term-loans … #franchise-financing) → specialty programs (#specialty) → comparison table
 * (#compare) → FAQ → footer.
 */
export default function LoanTypesPage() {
  return (
    <SiteShell>
      ...
      <PoliciesSection
        id="all-financing"
        heading={LOAN_TYPES_PRODUCTS_HEADER.heading}
        sub={LOAN_TYPES_PRODUCTS_HEADER.sub}
        cta={null}
        showSpecialtyStack={false}
        dataTrack="cta-loan-types-products"
      />
      <JourneySection />
      <LoanTypeDetails />
      <SpecialtyPrograms />
