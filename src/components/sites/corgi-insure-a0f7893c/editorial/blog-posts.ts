...
export const BLOG_POSTS: EditorialArticle[] = [
  ...
  },
  {
    ...
    thumbnail: { stat: "$250K", statLabel: "lines of credit with same-day decisions", footLead: "Compare:", footTail: " line vs. term loan", footTitle: "Seasonal cash" },
    inlineCtaAfter: "cost",
