    ...
    <section className="relative overflow-hidden border-[#e1e1e1] border-b bg-[#f6f6f6] px-4 py-16 md:px-6 md:py-20 lg:px-16">
      <div className="relative mx-auto flex w-full max-w-[1200px] flex-col gap-4 md:gap-6">
        ...
        <div className="flex flex-col gap-6 px-4 text-center md:px-6">
          <h2 className="font-medium font-mono text-[#191919] text-[length:var(--h2-font-size)] leading-[var(--h2-line-height)] tracking-[var(--h2-tracking)] [text-wrap:balance]">
            {heading}
          </h2>
        </div>
        ...
        <div className="relative w-full">
          ...
          <div className="relative w-full overflow-clip rounded-[8px] border border-[#e1e1e1] bg-white shadow-[0_0_24px_0_rgba(25,25,25,0.05)]">
            <div className="-m-px relative flex flex-col justify-center gap-4 overflow-clip rounded-[8px] bg-[#f6f6f6] px-7 py-6 shadow-[0_0_24px_0_rgba(25,25,25,0.05)] md:px-12 md:py-8 lg:px-16">
              {items.map((item, i) => (
