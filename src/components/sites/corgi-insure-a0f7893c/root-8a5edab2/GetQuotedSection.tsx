    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-[1600px]">
        ...
        <div className="grid grid-cols-1 items-center gap-8 py-6 md:gap-10 md:py-8 lg:grid-cols-2 lg:gap-12 lg:py-10">
            ...
            <ul className="flex flex-col gap-3">
              {GET_QUOTED.proof.map((item) => (
                <li key={item.label} className="flex items-center gap-3 text-body font-medium text-[#191919]">
                  <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#dde4f6] text-[#1e3a8a]">
          ...
          <div className="@container relative overflow-clip rounded-[24px] border border-[#e1e1e1] bg-[#2b4ca8] shadow-[0_0_24px_0_rgba(25,25,25,0.05)]">
