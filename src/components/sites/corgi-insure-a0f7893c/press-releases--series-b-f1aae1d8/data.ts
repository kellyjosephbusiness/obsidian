...
export const ARTICLE_BLOCKS: ArticleBlock[] = [
    ...
    paragraphs: [
      {
        ...
        text: " – FundLine Capital announced today it has raised $160 million in Series B funding at a $1.3 billion valuation, advancing its mission to build the first AI-native lending marketplace for small businesses. The company was founded by Maya Chen and Daniel Okoro.",
      },
    ],
  },
  {
    ...
    paragraphs: [
      ...
      {
        text: "This financing builds on FundLine Capital's previously announced $108 million across its seed and Series A rounds, backed by investors including Blue Cedar Ventures, Lantern Row, Highline Seed Fund, and more. Since opening its marketplace in July 2025, FundLine has connected owners with offers from more than 75 lenders through a single application.",
      },
  ...
  },
  {
    id: "expansion",
    tocLabel: "Expansion",
    heading: "Expanding the Marketplace",
    paragraphs: [
      {
        text: "The new capital will support the continued expansion of FundLine Capital's small-business loan products, including a broader lender network, embedded financing for the platforms owners already use, and ongoing investment in the AI matching engine that pairs each application with the right offers.",
      },
      {
  ...
  },
  {
    ...
    paragraphs: [
      {
        text: "FundLine Capital is an AI-native lending marketplace built for small businesses. With one application, owners receive offers from a network of more than 75 lenders, compare real terms side by side, and accept the one that fits, with no impact to their credit score to apply.",
      },
