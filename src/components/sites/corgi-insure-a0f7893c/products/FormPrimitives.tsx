...
export const INPUT_CLASS =
  "min-h-[44px] w-full rounded-[8px] border border-[#e1e1e1] bg-white px-3 py-2 text-[14px] leading-[1.2] tracking-[-0.21px] text-[#1d1d1d] outline-none transition-[border-color,box-shadow] duration-200 placeholder:text-[#6b6b6b] focus-visible:border-[#0376FD] focus-visible:shadow-[0_0_0_3px_rgba(30,58,138,0.25)]";
...
export function ThanksState({ heading, body }: ThanksStateProps) {
  return (
    <div role="status" className="flex flex-col items-center gap-4 rounded-[8px] border border-[#e1e1e1] bg-white px-6 py-12 text-center">
      <div className="flex size-12 items-center justify-center rounded-[8px] bg-[#DDEAFE]">
        <MaterialIcon name="check" size={28} className="text-[#0160CC]" />
      </div>
