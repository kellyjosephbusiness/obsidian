 ...
 * Each card: icon disc + title, summary, four spec tiles, dashed rule, rate + CTAs.
 */
          ...
          <div className="relative z-10 grid grid-cols-1 gap-6 md:grid-cols-2">
            {items.map((item) => (
              <article
                key={item.id}
                id={item.id}
                className="flex scroll-mt-[120px] flex-col gap-5 rounded-[24px] border border-[#e1e1e1] bg-white p-6 shadow-[0_0_24px_0_rgba(25,25,25,0.05)]"
              >
