...
/** Bordered callout band: stipple glyph, centred heading, bold lead + body, outline button. */
export function Callout({ callout }: { callout: DetailCallout }) {
  return (
    <Frame>
      <div className="flex flex-col items-center gap-6 rounded-[8px] border-[3px] border-[#C2DBFE] bg-white p-6 text-center md:flex-row md:gap-8 md:p-10">
        ...
        <div className="flex flex-1 flex-col gap-3">
          <h2 className="mx-auto font-mono text-[26px] font-medium leading-[1.05] tracking-[-0.03em] text-[#191919] md:text-[32px] [text-wrap:balance]">{callout.heading}</h2>
