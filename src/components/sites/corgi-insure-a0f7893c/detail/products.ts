...
export const PRODUCT_PAGES: DetailPageContent[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    hero: {
      headingLine1: "Fund the plan with a",
      headingLine2: "business term loan.",
      accentLine2: true,
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    hero: {
      headingLine1: "Grow with a business",
      headingLine2: "line of credit.",
      accentLine2: true,
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    hero: {
      headingLine1: "Stop waiting on",
      headingLine2: "net-60 customers.",
      accentLine2: true,
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    hero: {
      headingLine1: "Own the building",
      headingLine2: "you work in.",
      accentLine2: true,
