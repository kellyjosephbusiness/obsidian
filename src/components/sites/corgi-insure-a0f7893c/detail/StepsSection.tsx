...
function AppMock({ mock }: { mock: DetailAppMock }) {
  return (
    <div className="relative mx-auto w-full max-w-[420px]">
      <div aria-hidden className="absolute -left-10 top-16 size-[380px] rounded-[8px] bg-[#C2DBFE] md:-left-16 md:size-[460px]" />
      <div className="relative ml-auto w-[88%] overflow-hidden rounded-[8px] border border-[#e1e1e1] bg-white shadow-[0_0_24px_0_rgba(25,25,25,0.12)]">
        <div className="flex items-center justify-between bg-[#0376FD] px-4 py-3 text-white">
        ...
        <div className="flex flex-col gap-2 bg-[#f6f6f6] px-4 py-4">
          ...
          <div className="mt-1 h-1.5 w-full overflow-hidden rounded-full bg-[#e1e1e1]">
            <div className="h-full w-[18%] rounded-full bg-[#0376FD]" />
          </div>
        ...
        <div className="flex flex-col gap-3 px-4 py-4">
          <div className="flex h-10 items-center justify-center rounded-[4px] bg-[#0376FD] text-[13px] font-medium text-white">{mock.primaryAction}</div>
        ...
        <ol className="flex flex-col divide-y divide-[#e1e1e1]">
          {steps.items.map((step, i) => (
            <li key={step.title} className="flex gap-5 py-6 md:gap-7 md:py-8">
              <span className="flex size-12 shrink-0 items-center justify-center rounded-[8px] border-2 border-[#0376FD] font-mono text-[20px] font-medium text-[#0160CC]">{i + 1}</span>
