 ...
 * intro card) with a centred two-line heading, sub and primary + white pressable buttons.
 */
      ...
      <div className="relative mx-auto w-full max-w-[1600px]">
        <div className="relative overflow-hidden rounded-[8px] bg-[#313131] px-6 py-12 text-white md:px-16 md:py-20">
          ...
          <div className="relative flex flex-col items-center gap-8 text-center lg:gap-10">
            <div className="flex max-w-[760px] flex-col items-center gap-4 md:gap-6">
              <h2 className="mx-auto font-mono font-medium text-white text-[length:var(--h2-font-size)] leading-[var(--h2-line-height)] tracking-[var(--h2-tracking)] [text-wrap:balance]">
                <span className="block">{content.headingLine1}</span>
                <span className="block text-[#7FB6FE]">{content.headingLine2}</span>
              </h2>
              <p className="mx-auto max-w-[560px] text-body-large" style={{ color: "#d9d9d9" }}>{content.sub}</p>
            </div>
