...
/** Two-column mission block: sticky centred heading + pull quote on the left, three paragraphs on the right. */
    ...
    <section className="relative border-b border-[#e1e1e1] bg-[#f6f6f6] px-4 py-16 md:px-6 md:py-20 lg:px-16 lg:py-24">
      ...
      <div className="relative mx-auto grid w-full max-w-[1200px] grid-cols-1 gap-10 lg:grid-cols-[minmax(0,5fr)_minmax(0,7fr)] lg:gap-16">
        <div className="flex flex-col items-center gap-6 text-center lg:sticky lg:top-[116px] lg:self-start">
          <h2 className="mx-auto font-mono font-medium text-[#191919] text-[length:var(--h2-font-size)] leading-[var(--h2-line-height)] tracking-[var(--h2-tracking)] [text-wrap:balance]">
            {ABOUT_MISSION.heading}
          </h2>
          <p className="mx-auto max-w-[560px] border-t-2 border-[#0376FD] pt-5 font-serif text-[22px] italic leading-[1.3] tracking-[-0.02em] text-[#191919] md:text-[26px]">
            {ABOUT_MISSION.pull}
          </p>
        </div>
