...
/** /apply — centred intro column plus the live LendTrack funding application in a white card. */
  ...
  return (
    <section className="relative border-b border-[#e1e1e1] bg-[#f6f6f6] px-4 pt-[120px] pb-12 md:px-6 md:pt-[176px] md:pb-24 lg:px-16">
      <div className="relative mx-auto grid w-full max-w-[1200px] grid-cols-1 gap-6 lg:grid-cols-[minmax(0,5fr)_minmax(0,7fr)] lg:gap-16">
        <div className="flex flex-col items-center gap-4 text-center lg:sticky lg:top-[116px] lg:gap-6 lg:self-start">
          <h1 className="mx-auto font-mono font-medium text-[#191919] text-balance text-[32px] leading-none tracking-[-0.032em] md:text-[44px] lg:text-[34px] xl:text-[42px]">
            <span className="block">{APPLY_INTRO.headingLine1}</span>
            <span className="block">{APPLY_INTRO.headingLine2}</span>
          </h1>
          <p className="mx-auto max-w-[560px] text-[15px] leading-[1.35] tracking-[-0.2px] text-[#4a4a4a] md:text-body-large">{APPLY_INTRO.sub}</p>
          <ul className="mx-auto hidden w-fit flex-col gap-3 text-left lg:flex">
          ...
          <div className="mx-auto hidden w-full max-w-[520px] flex-col gap-4 rounded-[8px] border border-[#e1e1e1] bg-white p-5 lg:flex">
            ...
            <figure className="flex items-center justify-center gap-3 border-t border-[#e1e1e1] pt-4">
          ...
          <p className="mx-auto hidden text-[14px] leading-[1.3] tracking-[-0.21px] text-[#4a4a4a] lg:block">
